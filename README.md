...
<dependency>
  ...
  <version>16.1.0-s2</version>
  <!-- or Selenium 3 support: -->
  <version>16.1.0-s3</version>
</dependency>
```
...
dependencies {
  // either Selenium 2 support:
  compile 'com.nordstrom.ui-tools:selenium-foundation:16.1.0-s2'
  // or Selenium 3 support:
  compile 'com.nordstrom.ui-tools:selenium-foundation:16.1.0-s3'
}
```
