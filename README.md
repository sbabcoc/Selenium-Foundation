...
<dependency>
  ...
  <version>16.2.6-s2</version>
  <!-- or Selenium 3 support: -->
  <version>16.2.6-s3</version>
</dependency>
```
...
dependencies {
  // either Selenium 2 support:
  compile 'com.nordstrom.ui-tools:selenium-foundation:16.2.6-s2'
  // or Selenium 3 support:
  compile 'com.nordstrom.ui-tools:selenium-foundation:16.2.6-s3'
}
```
