 ...
 * <br>
 * The condition-polling mechanism employed by {@link ContainerMethodInterceptor#intercept(Object, Method, Object[],
 * Callable)} records instances of this exception, but will continue to poll until {@link DetectsLoadCompletion#
 * isLoadComplete()} completes without exception or time runs out. Note that it's not necessary to wrap instances of
 * {@link NotFoundException} (e.g. - {@link NoSuchElementException}) with this exception, as these are automatically
 * handled by {@link ComponentContainer#waitForLandingPage(Page)}.
 */
